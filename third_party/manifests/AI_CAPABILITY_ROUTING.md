...
6. `docs/research/AI_CAPABILITY_RESEARCH_2026-09-04.md`
...
| HTN / behavior trees | existing third-party research + `MistreevousSharp` | Deterministic routine orchestration |
...
5. Add HTN/behavior-tree adapter for deterministic routines.
6. Add ONNX/OCR perception adapters behind perception interfaces.
7. Add recovery state machine.
8. Add offline policy evaluation.
9. Add RL/self-play in simulation.
10. Promote only validated artifacts through the deterministic path.
