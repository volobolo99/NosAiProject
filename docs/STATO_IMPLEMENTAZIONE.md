...
- **Niente traffico reale è ancora stato catturato**: il driver WinDivert non è installato. Tutto il livello di cattura e analisi è provato su traffico sintetico e su file registrati.
