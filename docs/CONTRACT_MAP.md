...
| C-402 | AP-10 | Fuzzing sui pacchetti corrotti | TEST_VERIFIED | da definire | da definire | da definire |
...
| ORCH-005 | Tooling trasversale | Rendering deterministico di CONTRACT_MAP.md (niente modello, niente parafrasi) | TEST_VERIFIED | render_contract_map_markdown(ledger: dict) -> str | scripts/mcp_server.py | tests/test_contract_ledger.py |
