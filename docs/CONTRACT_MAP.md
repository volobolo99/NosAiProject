...
| C-103 | AP-02 | Motore di cattura del traffico di gioco | MERGED | vedi il file: superficie pubblica gia' in uso dai test | src/NosAi.Runtime/LiveIntegration/Capture/GameTrafficCaptureEngine.cs | tests/NosAi.Runtime.Tests/CaptureEngineTests.cs |
| C-104 | AP-02 | Parsing e registro degli opcode | MERGED | da confermare sul file prima di modificarlo | src/NosAi.Protocol/WireProtocol.cs | tests/NosAi.Runtime.Tests/OutEntityRecordedCaptureTests.cs |
| C-105 | AP-02 | Hook di memoria o DLL nel client | DRAFT | da definire | da definire | da definire |
| C-106 | AP-02, AP-09 | Replay deterministico di una cattura | MERGED | da confermare sul file | src/NosAi.Runtime/LiveIntegration/Capture/CaptureFile.cs | tests/NosAi.Runtime.Tests/DecideReplayAsOfCaptureTests.cs |
...
| C-203 | AP-01 | Fusione delle osservazioni nel World Model | MERGED | da confermare sul file | src/NosAi.Runtime/WorldModel/Fusion/WorldModelFusionLoop.cs | tests/NosAi.Runtime.Tests/ |
...
| C-401 | AP-00, AP-10 | Cifratura di sessione e autenticazione | MERGED | da confermare sul file | src/NosAi.Protocol/SessionCipher.cs | tests/test_session_cipher.py |
