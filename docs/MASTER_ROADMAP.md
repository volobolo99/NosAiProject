...
- C-103, C-104, C-106, C-203 and C-401 signatures were resolved from canonical source symbols on 2026-09-10. C-201, C-202, C-301, C-302, C-303, C-305 and C-403 followed on 2026-09-11, from source symbols already named in each contract's metrics field. Status remains historical unless the linked verification command is executed.
