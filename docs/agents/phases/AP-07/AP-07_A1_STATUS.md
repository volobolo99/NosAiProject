...
> superate dal codice. Verificato oggi nel sorgente: `LoadoutPlanner.GenerateEquipCandidates` esiste (`LoadoutPlanner.cs:62`) ed e' chiamato da `LoadoutReportCommand.cs`.
