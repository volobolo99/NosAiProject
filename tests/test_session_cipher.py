...
# A TelemetrySnapshot frame: NOSA, version 4, type 0x11, payload 0x2A, sequence 7.
# Only the version byte and the Poly1305 tag move with the v3 -> v4 bump: the header
# is the AEAD associated data, so the nonce and ciphertext are unchanged.
GOLDEN_HEADER = "4E4F53410411002A00000007"
GOLDEN_PLAINTEXT = b"gate1-snapshot"
GOLDEN_PAYLOAD = "000000000000000000000000803FC5ED76FBFF5E0AEB85DCAE313832A57013386CFE79224650B2FC5E9B"
