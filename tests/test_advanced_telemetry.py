...
def test_collector_average_and_snapshot():
    ...
    collector.record_tick_metrics(TelemetryMetrics(1, 0, 90, 90, 100, 80, 100, 92, TrustTier.TIER4, 0, 0))
    collector.record_tick_metrics(TelemetryMetrics(2, 1, 80, 90, 90, 80, 90, 86, TrustTier.TIER3, 1, 1))
